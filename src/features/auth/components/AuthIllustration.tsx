...
export function AuthIllustration() {
  return (
    <div className="hidden md:flex flex-col justify-between p-7 md:p-9 bg-primary-900 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 mt-auto mb-8 space-y-3">
      ...
      {/* Footer Ilustrasi */}
      <div className="relative z-10 pt-4 border-t border-white/20 text-xs text-white/80 flex items-center justify-between font-medium">
