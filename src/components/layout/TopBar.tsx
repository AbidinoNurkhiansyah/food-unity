...
export function TopBar() {
  return (
    <div className="bg-palette-800 text-white flex justify-between items-stretch text-sm relative z-20">
      <div className="flex gap-4 sm:gap-6 py-2 sm:py-2.5 px-4 lg:pl-[130px] flex-wrap items-center justify-center lg:justify-start w-full lg:w-auto">
        <div className="flex items-center gap-1.5 sm:gap-2">
          <Phone className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary-500 shrink-0" />
          <span className="text-xs sm:text-sm">083870631247</span>
        </div>
        <div className="flex items-center gap-1.5 sm:gap-2">
          <Mail className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary-500 shrink-0" />
          <span className="text-xs sm:text-sm">foodunity@gmail.com</span>
        </div>
        <div className="hidden md:flex items-center gap-1.5 sm:gap-2">
          <MapPin className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary-500 shrink-0" />
          <span className="text-xs sm:text-sm">Klari, Karawang, Jawa barat, Indonesia</span>
        </div>
      </div>
